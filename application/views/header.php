...
<head>
    ...
    <link rel="icon" href="<?php echo base_url('assets/LogoBengkel2.png') ?>" type="image/png">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #2D3648;">
        <div class="container">
            ...
            <a href="<?php echo base_url('welcome') ?>" class="navbar-brand ms-2" style="font-size: 30px; font-weight: 400;">Morodadi Radiator</a>
            ...
            <div class="collapse navbar-collapse" id="naff">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo base_url('lacak') ?>" class="nav-link">Pelacakan</a>
                    </li>
                    <li class="nav-item">
